                  ...
                  {cat.lastPostTitle ? (
                    <div className="space-y-1">
                      ...
                      <div className="text-zinc-500 text-xs">
                        por <Link
                          to={`/profile/${cat.lastPostAuthor}`}
                          className="text-zinc-300 hover:text-[#f0ac00] hover:underline font-medium transition cursor-pointer">
                          {cat.lastPostAuthor || 'Usuario'}
                        </Link><br />
